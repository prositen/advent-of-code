...
from python.src.y2019.dec14 import Dec14
...
class TestDec14(unittest.TestCase):
    ...
    def test_part_1_d(self):
        reactions = ["2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG",
                     ...
                     "176 ORE => 6 VJHF"]
        d = Dec14(instructions=reactions)
        self.assertEqual(180697, d.part_1())
    ...
    def test_part_1_e(self):
        ...
        d = Dec14(instructions=reactions)
        self.assertEqual(2210736, d.part_1())
