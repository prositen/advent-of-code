...
class Dec21Tests(unittest.TestCase):
    def test_part1_example1(self):
        ...
        game = dec22.Game(player, boss)
        self.assertEquals(player, game.winner())
        ...
        self.assertEquals(["Poison deals 3 damage; its timer is now 5.",
                           "Boss attacks for 8 damage"], game.round(1).message(player=False))
        self.assertEquals(["Player casts Magic Missile, dealing 4 damage"], game.round(2).message(player=True))
